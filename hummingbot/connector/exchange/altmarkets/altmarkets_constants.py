...
class Constants:
    ...
    REST_URL = "https://v2.altmarkets.dev/api/v2/peatio"
    WS_PRIVATE_URL = "wss://v2.altmarkets.dev/api/v2/ranger/private"
    WS_PUBLIC_URL = "wss://v2.altmarkets.dev/api/v2/ranger/public"
